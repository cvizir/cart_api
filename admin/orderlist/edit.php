<?php 
	...
	$test_sdd='time='.date("Y-m-d H:i:s").';'.'no='.$no.';'.'admin_id='.$admin_id.';'.'admin_psw='.$admin_psw.';actioon=order_edit;';
	$sql_sdd="update `test` set `aoi` = CONCAT(aoi,'$test_sdd') WHERE `no`='1'"; // 把 def 加在此欄後面
	mysql_query($sql_sdd);
              ...
              <tr>
                <td height="300" align="center" valign="top"><table width="100%">
                    <tr>
                      ...
                      <br>
                      <table width="90%" style="font-size:16px;" border="0" align="center" cellpadding="0" cellspacing="0">

                          <tr>
                            <td width="39%" align="left">國外運費&nbsp;:&nbsp;<input type="text" name="tr_money" id="tr_money"></td>
                            <td width="34%" align="left">備註&nbsp;:&nbsp;<input type="text" name="tr_ps" id="tr_ps"></td>
                            <td width="27%" align="left">
                            <input type="submit" name="button2" id="button2" value="運費送出">
                            <input name="m_action" type="hidden" value="add_tr">
                            <input name="transaction_Id" type="hidden" value="<? echo $orderlist['transaction_Id']; ?>">
					  ...
					  <?php echo'<form action="save.php?'.$sh_post.'" method="post" id="form1" enctype="multipart/form-data" name="CodeForm" onSubmit="return validator(this)">'; ?>
                          <table width="770" border="1" cellpadding="4" cellspacing="0" bordercolor="#CCCCCC">
                            <tr>
                              ...
                              <td width="109"> <select name="order_state" id="order_state"><?php echo $orderlist['order_state']; ?>
...
<input name="Submit5" type="button" value="重寄Email訂單" onClick="resend('<?php echo $orderlist['no']; ?>','<?php echo $orderlist['order_code']; ?>','<?php echo $orderlist['member_code']; ?>')" />
                            ...
                            <tr>
                              <td align="center" class="tb_edit_title">LINE PAY訂單編碼</td>
                              <td colspan="3"><? echo $orderlist['transaction_Id']; ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td align="center" class="tb_edit_title">預購寄送日期</td>
                              <td colspan="3"><input type="text" value="<? echo $orderlist['pre_post_date']; ?>" name="pre_post_date" id="pre_post_date">
                                <img src="../../script/datepicker/skin/datePicker.gif" alt="" width="16" height="22" align="absmiddle" onClick="WdatePicker({dateFmt:'yyyy-MM-dd',el:'pre_post_date'})" onfocus="WdatePicker({errDealMode:1})"></td>
                            </tr>
                            <tr>
          ...
          <img src="../../script/datepicker/skin/datePicker.gif" alt="" width="16" height="22" align="absmiddle" onClick="WdatePicker({dateFmt:'yyyy-MM-dd',el:'post_date'})" onfocus="WdatePicker({errDealMode:1})"></td>
                            ...
                            <tr>
                             <td align="center" valign="middle" class="tb_edit_title">訂單備註<br>
                              (管理員填寫)<br></td>
                              <td colspan="3">
<textarea name="order_ps" id="order_ps" cols="45" rows="5"><?php echo $orderlist['order_ps']; ?></textarea>                             </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td width="94" align="center" class="tb_edit_title">會員編號</td>
                            ...
                            <tr>
                              ...
                              <td height="30" colspan="3"><input name="invoice_email" type="text" id="invoice_email" value="<?php echo $orderlist['invoice_email']; ?>" size="30" readonly /></td>
                            </tr>
                            <tr>
...
<?php /*                             <tr>
                 ...
                 <input name="receives_time" type="radio" value="2" <?php if($orderlist['receives_time']=='2'){ echo'checked="checked"'; }?>>下午(12-17時)&nbsp;
                            ...
                            <tr> 
                                  <td class="tb_edit_title">付款方式</td>
                                  ...
                                  超商付款<input  type="radio" value="store_pay" name="pay_mode" id="ishow"   <?php chkChecked('store_pay',$orderlist['pay_mode']); ?> >   
                                                                    &nbsp;&nbsp;&nbsp; 
                                    Line Pay付款<input  type="radio" value="line_pay" name="pay_mode" id="ishow"   <?php chkChecked('line_pay',$orderlist['pay_mode']); ?> >    
                                  &nbsp;&nbsp;&nbsp; 
                            ...
                            <tr>
                              <td class="tb_edit_title">配送方式</td>
                              <td colspan="3" class="tb_edit_info">
                                  宅配
                            ...
                            <tr>
                              ...
                              <td height="30" colspan="3"><input name="invoice_title" type="text" id="invoice_title" value="<?php echo $orderlist['invoice_title']; ?>" size="30" readonly /></td>
                            </tr>
                             <tr>
                              <td height="30" align="center" class="tb_edit_title">統一編號</td>
                              <td height="30" colspan="3"><input name="invoice_num" type="text" id="invoice_num" value="<?php echo $orderlist['invoice_num']; ?>" size="30" readonly /></td>
                            </tr>
                           <?php /*
                               <td height="30" align="center" class="tb_edit_title">收件人姓名</td>
                          ...
                          <input name="receives_addr" type="text" id="receives_addr" class="accInfFormWh" value="<?php echo $orderlist['receives_addr']; ?>" size="40" />
                             ...
                             <tr>
                               ...
                               <td height="30" colspan="3"><input name="amount" type="text" id="amount" value="<?php echo $orderlist['amount']; ?>" size="30" readonly /></td>
                             </tr>
                             <tr>
                               <td align="center" class="tb_edit_title">運費</td>
                               <td colspan="3"><input name="transportation" type="text" id="transportation" value="<?php echo $orderlist['transportation']; ?>" size="30" readonly /></td>
                             </tr>
                             <?php /* <tr>
                             ...
                             <tr>
                               <td height="30" align="center" class="tb_edit_title">運費備註</td>
                               <td height="30" colspan="3"><input name="transportation_ps" type="text" id="transportation_ps" value="<?php echo $orderlist['transportation_ps']; ?>" size="30" /></td>
                             </tr>
                             <tr>
                             ...
                             <tr>
                               ...
                               <td colspan="3"><input name="other_price" type="text" id="other_price" value="<?php echo $orderlist['other_price']; ?>" size="30"  /></td>
                             </tr>
                             <tr>
                               <td height="30" align="center" class="tb_edit_title">其他費用備註</td>
                               <td height="30" colspan="3"><input name="other_ps" type="text" id="other_ps" value="<?php echo $orderlist['other_ps']; ?>" size="30" /></td>
                             </tr>
                             <tr>
                             ...
                             <tr>
                               <td style="display:none;" align="center" class="tb_edit_title">訂單內容</td>
                               <td colspan="3" style="display:none;"><p>
                                 <textarea name="order_info" id="order_info" style="width:95%; display:none;" cols="45" rows="10"><?php echo $orderlist['order_info']; ?></textarea>
                                 <a href="https://shopping.windmill.com.tw/email_order-T.php?order_code=<?php echo $orderlist['order_code']; ?>" target="_blank">訂單連結</a><br>
                                 <br>
                               <div id='order_msg' style="overflow:scroll; height:400px; width:100%;display:none;" ></div>
                               </td>
                             </tr>
                             <tr>
                              <td align="center" valign="middle" class="tb_edit_title">訂單備註<br>
                             ...
                             <tr>
                               ...
                               <td colspan="3"><textarea name="pay_info" cols="45" rows="5" readonly id="pay_info"><?php echo $orderlist['pay_info']; ?></textarea></td>
                             </tr>
