<? 
	...
	if(count($no_id)>=2){
		for( $I=0; $I <= count($no_id); $I++ ){
			$sql_sort="UPDATE `billboard` SET `m_sort` = '".($I+1)."' WHERE `no` ='".$no_id[$I]."'";
...
<link href="../billboard/favicon3.ico" rel="shortcut icon">
...
<style type="text/css">
	...
	.main { cursor:pointer; position: static; width: 600px;  margin-bottom: 5px; padding: 5px; border: 1px dashed #00f; background: #fff; }
...
<form name="form1" method="post" action="sort.php">
...
<td width="90%" valign="top"><div align="center"><br />
            <table width="850" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td width="835" height="100">
                  <div class="box" id="box" >
                    <?php 
			   $sql_cat="SELECT * FROM `billboard` WHERE `cat_id` ='$bd_id' ORDER BY `m_sort` ASC , `no` DESC";
			   //echo"$sql_cat";
			   ...
			   ?>
                    <div class="main" >
                      ...
                      <?php }else{?>
                      <img src="../../images/upload/billboard/billboard_<?php echo sprintf("%06d", $row_cat['no']); ?>.jpg" width="110">
                      <?php }?>
              ...
              <tr>
                <td height="17">&nbsp;</td>
                <td height="30" valign="top"><div class="btnblack">
                  
                  <input name="bd_id" type="hidden" id="bd_id" value="<?php echo "$bd_id"; ?>">
                  <input name="Submit2" type="submit" value="送出" />
